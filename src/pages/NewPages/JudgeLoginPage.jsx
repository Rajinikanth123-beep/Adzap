...
export default function JudgeLoginPage({ onLogin, onNavigate, showDefaultLogin = false }) {
  ...
  const handleSubmit = async (e) => {
    ...
    setError('Invalid judge email or password');
  };
  ...
  return (
    <div className="login-page">
      <div className="login-container">
        ...
        <p className="login-subtitle">Login to the judge dashboard</p>

        {showDefaultLogin && (
          <div className="login-roles">
            <p className="roles-title">Default Judge Accounts:</p>
            <div className="role-card">
              <p>judge1@adzap.com</p>
              <p>judge2@adzap.com</p>
        ...
        <form onSubmit={handleSubmit} className="login-form">
          ...
          <button type="submit" className="btn btn-submit">Login as Judge</button>

          <div className="login-footer">
            <p>
              New judge?{' '}
              <button type="button" onClick={() => onNavigate('judge-register')} className="link-btn">
                Register here
              </button>
            </p>
